...
//import "./utils/EchoCrossChainTest.sol";
...
//    EchoCrossChainTest echoSource;
//    EchoCrossChainTest echoTarget;
//
...
//
//        apes = new MockERC721("Apes", "APE");
//        birds = new MockERC721("Birds", "BIRD");
//
...
//                uint32(vm.envUint("TESTING_AVAX_WORMHOLE_GUARDIAN_SET_INDEX")),
//            "wrong guardian set index"
//        );
//
//        echoSource = new EchoCrossChainTest(
//            address(owner),
//            address(wormhole),
//            wormhole.chainId(),
//            uint8(1)
//        );
//        echoTarget = new EchoCrossChainTest(address(owner), address(wormhole), uint8(2), uint8(1));
//
...
//        vm.prank(receiver);
//        birds.safeTransferFrom(receiver, address(echoTarget), 1);
//        assertEq(birds.ownerOf(1), address(echoTarget));
//    }
//
...
//        });
//        echoTarget.sendMessage(message);
//
...
//        echoSource.registerEmitter(
//            echoTarget.chainId(),
//            bytes32(uint256(uint160(address(echoTarget))))
//        );
//        vm.stopPrank();
//
//        vm.startPrank(receiver);
//        birds.approve(address(echoSource), 1);
...
//
//        vm.expectRevert(MessageAlreadyConsumed.selector);
//        echoSource.receiveMessage(encodedMessage);
//    }
//}
